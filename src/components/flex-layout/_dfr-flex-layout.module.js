  var styles = require('./_dfr-flex-layout.scss');

  var $interpolate, $log;

  var $module = angular.module('dfr.utilities.flex-layout', ['ng']);

  var SUFFIXES = /(-gt)?-(sm|md|lg|print)/g;
  var WHITESPACE = /\s+/g;

  var FLEX_OPTIONS = ['grow', 'initial', 'auto', 'none', 'noshrink', 'nogrow' ];
  var LAYOUT_OPTIONS = ['row', 'column', 'none'];
  var ALIGNMENT_MAIN_AXIS= [ "", "start", "center", "end", "stretch", "space-around", "space-between", 'none' ];
  var ALIGNMENT_CROSS_AXIS= [ "", "start", "center", "end", "stretch", 'none' ];
...
/**
  ...
  var config = {
     ...
     * Developers can use `<body dfr-layout-css />` to quickly
  ...
  function registerLayoutAPI(module){
    ...
    module
      ...
      .directive('dfrLayoutCss'        , disableLayoutDirective )
  ...
  /**
    * Detect if any of the HTML tags has a [dfr-layouts-disabled] attribute;
   ...
   function detectDisabledLayouts() {
     var isDisabled = !!document.querySelector('[dfr-layouts-disabled]');
   ...
   * </body>
   *
   * Note: Using dfr-layout-css directive requires the developer to load the Material
   ...
   * conversions; this would obviate the use of the `dfr-layout-css` directive
   *
   */
  ...
  function attributeWithObserve(className) {
    ...
    return ['$interpolate', "$log", function(_$interpolate_, _$log_) {
  ...
  function validateAttributeUsage(className, attr, element, $log){
    ...
    switch(className.replace(SUFFIXES,"")) {
      case "flex":
        if ((nodeName == "dfr-button") || (nodeName == "fieldset")){
